...
const TUTORIAL_VERSION = 11; // bump when copy changes → existing installs self-heal
...
function buildTutorialNotes() {
  return [
    ...
    makeTutorialNote("t04", 4,  30,  "Who is it for?", "Add their name in the panel.\nWhoever's on your mind right now, this one's for them."),
    makeTutorialNote("t05", 5,  40,  "Write your note", "Whatever this moment in the song stirs in you, write it down here."),
    makeTutorialNote("t06", 6,  50,  "Pin it to the second", "Tap **Now** to catch the current moment or type in a timestamp if another part of the song is calling you."),
    makeTutorialNote("t07", 7,  60,  "Save it", "Hit **Save note** and it's sealed.\nAdd as many notes as you'd like, across as many songs as you wish."),
    makeTutorialNote("t08", 8,  70,  "Add a description", "Scroll to the share panel and leave a little description.\nIt's the first thing they read, before the music begins."),
    makeTutorialNote("t09", 9,  80,  "Share it", "Hit **Share** to get your link.\nWrote across a few songs? You'll drop in the playlist link first."),
    makeTutorialNote("t10", 10, 90,  "Send it off", "To anyone, anywhere.\nIt opens as a quiet little card holding every note you left. Once they install Keepsake, those notes appear as the music plays."),
    makeTutorialNote("t11", 11, 100, "Relive anywhere", "Turn on **Cross-device Relive** and choose a private passphrase.\nIt securely ties your keepsakes to your account, so they'll be waiting for you even on a new device. Your passphrase stays with you, which means only you can unlock them."),
