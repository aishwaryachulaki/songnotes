...
function makeTutorialOverlay(active) {
  return {
    ...
    notes: [
      ...
      mkNote("t10", 10, 63, "Want your keepsakes on every device you use? Turn on Cross-device relive, pick a private passphrase, and they follow you everywhere. Only you can unlock them."),
      mkNote("t11", 11, 70, "And if they add Keepsake, your notes come alive as they listen. That's everything. Go make someone's day. ✦"),
    ],
  };
}
